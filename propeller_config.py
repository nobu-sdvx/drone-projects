...
W_TOTAL = 0.358              # 機体総重量 [N](36.5 g、v3 重量重心書と統一 2026-05-17)
V_CRUISE = 7.5               # 巡航速度 [m/s]
V_MAX = 9.0                  # 最大速度 [m/s]
Q_CRUISE = 34.45             # 動圧 @ V=7.5 m/s [Pa]

L_WING_DESIGN = 0.398        # 主翼揚力(設計点、W+|L_t| = 0.358+0.040) [N]
L_WING_LIMIT = 0.398         # 主翼揚力(限界点) [N]
D_TOTAL_AIRFRAME = 0.0442    # 全機抗力(主翼 38.7 + 尾翼 5.5 mN) [N]
D_FUSELAGE_EST = 0.010       # 胴体抗力推定(保守側) [N]
D_TOTAL = 0.0542             # 全機抗力(推定、約 54 mN) [N]
T_REQUIRED_PER_MOTOR = D_TOTAL / 2.0   # 1 モーター必要推力 = 0.0271 [N]
...
RPM_CRUISE = 25264           # 巡航動作RPM(QPROP: V=7.5 で必要推力 27.1mN 到達、2026-05-17確定) [rpm]
